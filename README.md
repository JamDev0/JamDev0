...
- **Backend & platform:** NestJS, TypeORM/Prisma, request validation (Zod), and API design with OpenAPI.
- **Reliability:** Tests (Jest), CI/CD (GitHub Actions), and Docker-based builds.
- **Full-stack alignment:** Auth and token flows across React/Next.js frontends and Node backends.
